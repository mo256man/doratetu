...
function Title({ setView }) {
    const [showCredit, setShowCredit] = useState(false);
    const [showDebug, setShowDebug] = useState(false);
    const credit =
        <div className="credit">
            <img src="mo_square.png" className="img-credit" onClick={() => setView("")} />
        </div>
    ...
    const areaStart =
        <div className="frame start-area color-game">
            <div className="center"><div className="start-button font-saiyan" onClick={() => {setView("game")}}>ゲームスタート</div></div>
    ...
    const areaDebug =
        <div className="frame start-area color-debug">
            <div className="center"><div className="start-button font-saiyan" onClick={() => setView("education")}>教育版スタート</div></div>
            物件と地図とストリートビューを<br />
            駅名（地名）と照らし合わせながら<br />
            地理の勉強をしよう！<br />
        </div>
